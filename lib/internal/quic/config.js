...
class EndpointConfig {
  ...
  static isEndpointConfig(val) {
    return typeof val?.[kOptions] === 'object' &&
      val[SymbolToStringTag] === 'EndpointConfig';
  }
  ...
  get [SymbolToStringTag]() { return 'EndpointConfig'; }
}
...
class SessionConfig {
  ...
  static isSessionConfig(val) {
    return typeof val?.[kOptions] === 'object' &&
      val[SymbolToStringTag] === 'SessionConfig';
  }
  ...
  get [SymbolToStringTag]() { return 'SessionConfig'; }
}
...
class StreamOptions {
  ...
  static isStreamOptions(val) {
    return typeof val?.[kOptions] === 'object' &&
      val[SymbolToStringTag] === 'StreamOptions';
  }
  ...
  get [SymbolToStringTag]() { return 'StreamOptions'; }
}
...
class ResponseOptions {
  ...
  static isResponseOptions(val) {
    return typeof val?.[kOptions] === 'object' &&
      val[SymbolToStringTag] === 'ResponseOptions';
  }
  ...
  get [SymbolToStringTag]() { return 'ResponseOptions'; }
}
