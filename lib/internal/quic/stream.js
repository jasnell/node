...
ObjectDefineProperties(Stream.prototype, {
  blocked: { enumerable: true },
  closed: { enumerable: true },
  cancel: { enumerable: true },
  headers: { enumerable: true },
  id: { enumerable: true },
  locked: { enumerable: true },
  readableStream: { enumerable: true },
  respondWith: { enumerable: true },
  responseHints: { enumerable: true },
  serverInitiated: { enumerable: true },
  session: { enumerable: true },
  stats: { enumerable: true },
  streamReadable: { enumerable: true },
  trailers: { enumerable: true },
  unidirectional: { enumerable: true },
});
