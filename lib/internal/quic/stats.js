...
ObjectDefineProperties(EndpointStats.prototype, {
  createdAt: { enumerable: true },
  duration: { enumerable: true },
  bytesReceived: { enumerable: true },
  bytesSent: { enumerable: true },
  packetsReceived: { enumerable: true },
  packetsSent: { enumerable: true },
  serverSessions: { enumerable: true },
  clientSessions: { enumerable: true },
  statelessResetCount: { enumerable: true },
  serverBusyCount: { enumerable: true },
});
...
ObjectDefineProperties(SessionStats.prototype, {
  createdAt: { enumerable: true },
  duration: { enumerable: true },
  handshakeCompletedAt: { enumerable: true },
  handshakeConfirmedAt: { enumerable: true },
  lastSentAt: { enumerable: true },
  lastReceivedAt: { enumerable: true },
  closingAt: { enumerable: true },
  bytesReceived: { enumerable: true },
  bytesSent: { enumerable: true },
  bidiStreamCount: { enumerable: true },
  uniStreamCount: { enumerable: true },
  inboundStreamsCount: { enumerable: true },
  outboundStreamsCount: { enumerable: true },
  keyUpdateCount: { enumerable: true },
  lossRetransmitCount: { enumerable: true },
  maxBytesInFlight: { enumerable: true },
  blockCount: { enumerable: true },
  bytesInFlight: { enumerable: true },
  congestionRecoveryStartTS: { enumerable: true },
  cwnd: { enumerable: true },
  deliveryRateSec: { enumerable: true },
  firstRttSampleTS: { enumerable: true },
  initialRtt: { enumerable: true },
  lastSentPacketTS: { enumerable: true },
  latestRtt: { enumerable: true },
  lossDetectionTimer: { enumerable: true },
  lossTime: { enumerable: true },
  maxUdpPayloadSize: { enumerable: true },
  minRtt: { enumerable: true },
  ptoCount: { enumerable: true },
  rttVar: { enumerable: true },
  smoothedRtt: { enumerable: true },
  ssthresh: { enumerable: true },
  receiveRate: { enumerable: true },
  sendRate: { enumerable: true },
});
...
ObjectDefineProperties(StreamStats.prototype, {
  ...
  duration: { enumerable: true },
  lastReceivedAt: { enumerable: true },
  lastAcknowledgeAt: { enumerable: true },
  closingAt: { enumerable: true },
  bytesReceived: { enumerable: true },
  bytesSent: { enumerable: true },
  maxOffset: { enumerable: true },
  maxOffsetAcknowledged: { enumerable: true },
  maxOffsetReceived: { enumerable: true },
  finalSize: { enumerable: true },
});
