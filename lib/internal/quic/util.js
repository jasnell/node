...
class EndpointConfig {
  ...
  get family() { return this[kOptions].family; }
}
...
class SessionOptions {
  ...
  [kCreateClientContext]() {
    const context = createClientSecureContext();
    configSecureContext(context, this[kOptions].secure);
    return context;
  }

  [kCreateServerContext]() {
    const context = createServerSecureContext();
    configSecureContext(context, this[kOptions].secure);
    return context;
  }
