    ...
    transform: async function*(source, options) {
      ...
      function processInputAsync(input, flushFlag) {
        ...
        handle.write(flushFlag,
                     input, 0, TypedArrayPrototypeGetByteLength(input),
                     outBuf, outOffset, writeAvailOutBefore);
        return promise;
      }
      ...
      function drainBatch() {
        ...
        while (pending.length > 0 && batchBytes < BATCH_HWM) {
          ...
          batchBytes += TypedArrayPrototypeGetByteLength(buf);
          pendingBytes -= TypedArrayPrototypeGetByteLength(buf);
        }
        return batch;
      }
...
function compressGzip(options = { __proto__: null }) {
...
function compressDeflate(options = { __proto__: null }) {
  validateObject(options, 'options');
  return makeZlibTransform(
...
function compressBrotli(options = { __proto__: null }) {
  validateObject(options, 'options');
  return makeZlibTransform(
...
function compressZstd(options = { __proto__: null }) {
  validateObject(options, 'options');
  return makeZlibTransform(
...
function decompressGzip(options = { __proto__: null }) {
  validateObject(options, 'options');
  return makeZlibTransform(
...
function decompressDeflate(options = { __proto__: null }) {
  validateObject(options, 'options');
  return makeZlibTransform(
...
function decompressBrotli(options = { __proto__: null }) {
  validateObject(options, 'options');
  return makeZlibTransform(
...
function decompressZstd(options = { __proto__: null }) {
  validateObject(options, 'options');
  return makeZlibTransform(
