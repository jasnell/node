...
/**
 * Evaluates `code` as the entry point, the way `node --eval` and
 * `node --print` do.
 * @param {string} code The source to evaluate.
 * @param {boolean} print Whether to print the result.
 */
function evalEntryPointString(code, print) {
