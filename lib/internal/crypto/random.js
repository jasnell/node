...
// A process forked from a zygote must not hand out the buffered random bytes
// it inherited from its parent (and siblings).
function resetRandomCachesForFork() {
  randomCacheOffset = randomCache.length;
  uuidBatch = 0;
}
