...
// issue GH-4331
assert.throws(function() {
  Buffer.alloc(0xFFFFFFFF);
}, RangeError);
assert.throws(function() {
  Buffer.alloc(0xFFFFFFFFF);
}, RangeError);
...
// Test Compare
var b = Buffer.alloc(1).fill('a');
var c = Buffer.alloc(1).fill('c');
var d = Buffer.alloc(2).fill('aa');
...
// Test Equals
var b = Buffer.alloc(5).fill('abcdf');
var c = Buffer.alloc(5).fill('abcdf');
var d = Buffer.alloc(5).fill('abcde');
var e = Buffer.alloc(6).fill('abcdef');
