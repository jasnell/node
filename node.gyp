      ...
      'conditions': [
        ...
        [
          ...
          'sources': [
            'src/node_bob.h',
            'src/node_bob-inl.h',
            'src/quic/quic_buffer.h',
            'src/quic/quic_buffer-inl.h',
            'src/quic/quic_crypto.h',
            'src/quic/quic_session.h',
            'src/quic/quic_session-inl.h',
            'src/quic/quic_socket.h',
            'src/quic/quic_socket-inl.h',
            'src/quic/quic_stream.h',
            'src/quic/quic_stream-inl.h',
            'src/quic/quic_util.h',
            'src/quic/quic_util-inl.h',
            'src/quic/quic_state.h',
            'src/quic/quic_default_application.h',
            'src/quic/quic_http3_application.h',
            'src/quic/quic_buffer.cc',
            'src/quic/quic_crypto.cc',
            'src/quic/quic_session.cc',
            'src/quic/quic_socket.cc',
            'src/quic/quic_stream.cc',
            'src/quic/quic.cc',
            'src/quic/quic_default_application.cc',
            'src/quic/quic_http3_application.cc'
          ]
        }],
        [ 'use_openssl_def==1', {
