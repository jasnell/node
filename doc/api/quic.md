...
const session = client.connect({ address: '123.123.123.123', port: 1234 });
...
* Type: {Object} A null-prototype object containing the headers that have
  been received for this `Stream` (only supported if the ALPN-identified
