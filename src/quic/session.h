...
class Session final : public AsyncWrap,
 ...
 public:
  ...
  struct Options final : public MemoryRetainer {
    ...
    std::string alpn = &NGHTTP3_ALPN_H3[1];
  ...
  class CryptoContext final : public MemoryRetainer {
   ...
   private:
    void MaybeSetEarlySession(const std::shared_ptr<Options>& options);
    bool SetSecrets(
        ngtcp2_crypto_level level,
        const uint8_t* rx_secret,
        const uint8_t* tx_secret,
  ...
  class Application : public MemoryRetainer {
   public:
    ...
    virtual bool SubmitHeaders(
        stream_id id,
        Stream::HeadersKind kind,
        const v8::Local<v8::Array>& headers) { return false; }
 ...
 private:
  ...
  bool HandshakeCompleted(const SocketAddress& remote_addr);
