...
class Http3Application final : public Session::Application,
 ...
 public:
  ...
  // Implementation for mem::NgLibMemoryManager. In the
  // implementation we simply defer to node::quic::BindingState
  // but we need separate implementations here because BindingState
  // maps to ngtcp2_mem while Http3Application maps to nghttp3_mem.
