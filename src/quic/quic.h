...
// BindingState stores the persistent state of the internalBinding('quic')
// binding. This includes persistent strings, constructor FunctionTemplates,
// etc.
...
#define QUIC_JS_CALLBACKS(V)                                                   \
  ...
  V(session_use_preferred_address, SessionUsePreferredAddress)                 \
