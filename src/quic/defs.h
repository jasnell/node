...
#define QUIC_ALPN_H3 NGHTTP3_ALPN_H3
...
#define QUIC_MIN_CIDLEN NGTCP2_MIN_CIDLEN
...
#define QUIC_VERSION_NEGOTIATION_ERROR NGTCP2_VERSION_NEGOTIATION_ERROR_DRAFT
...
#define QUIC_FLAG(flags, Name) ((flags & Name) == Name)
...
constexpr size_t kMaxLogStreamBuffer = 1024 * 10;
...
constexpr size_t TOKEN_SECRET_LENGTH = 16;
...
#define GET_CONSTRUCTOR_TEMPLATE()                                             \
  static v8::Local<v8::FunctionTemplate> GetConstructorTemplate(               \
      Environment* env);

#define BASEOBJECT_INIT()                                                      \
