...
JSQuicBufferConsumer::JSQuicBufferConsumer(
    Environment* env,
    Local<Object> wrap)
...
void JSQuicBufferConsumer::Initialize(Environment* env, Local<Object> target) {
  ...
  env->SetConstructorFunction(target, "JSQuicBufferConsumer", temp);
}
...
void ArrayBufferViewSource::Initialize(Environment* env, Local<Object> target) {
  ...
  temp->Inherit(BaseObject::GetConstructorTemplate(env));
  temp->InstanceTemplate()->SetInternalFieldCount(
      Buffer::Source::kInternalFieldCount);
  env->SetConstructorFunction(target, "ArrayBufferViewSource", temp);
}
...
void StreamSource::Initialize(Environment* env, Local<Object> target) {
  ...
  env->SetConstructorFunction(target, "StreamSource", temp);
}
...
void StreamBaseSource::Initialize(Environment* env, Local<Object> target) {
  ...
  temp->InstanceTemplate()->SetInternalFieldCount(
      Buffer::Source::kInternalFieldCount);
  env->SetConstructorFunction(target, "StreamBaseSource", temp);
}
